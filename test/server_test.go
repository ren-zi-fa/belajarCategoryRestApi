...
import (
	...
	"net/http"
	"net/http/httptest"
	"ren-zi-fa/BelajarRestfullApi/app"
	"ren-zi-fa/BelajarRestfullApi/controller"
	"ren-zi-fa/BelajarRestfullApi/helper"
	"ren-zi-fa/BelajarRestfullApi/middleware"
	"ren-zi-fa/BelajarRestfullApi/model/domain"
	"ren-zi-fa/BelajarRestfullApi/repository"
	"ren-zi-fa/BelajarRestfullApi/service"
	"strconv"
	"strings"
	"testing"
	"time"
...
func TestCreateCategoryFailed(t *testing.T) {
	...
	requestBody := strings.NewReader(`{"name" : "danang"}`)
	request := httptest.NewRequest(http.MethodPost, "http://localhost:8080/api/categories", requestBody)
	request.Header.Add("Content-Type", "application/json")
	request.Header.Add("X-API-Key", "RAHASIA")
